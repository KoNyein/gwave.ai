...
ARG NEXT_PUBLIC_IVS_RECORDING_BASE
# Metaverse multiplayer WebSocket URL (wss://mv.gwave.cc). Unset = the world
# runs single-player — the page works, nobody else is in it.
ARG NEXT_PUBLIC_MV_WS_URL
...
ENV NEXT_PUBLIC_MV_WS_URL=$NEXT_PUBLIC_MV_WS_URL
...
ENV NEXT_PUBLIC_IVS_RECORDING_BASE=$NEXT_PUBLIC_IVS_RECORDING_BASE
