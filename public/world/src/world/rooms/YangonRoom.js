...
export class YangonRoom extends Room {
  ...
  build() {
    ...
    addTerrain(this, {
      ...
      // ★ r ကို **မြစ်ရဲ့ အရှည်နဲ့ တွက်ထုတ်ရမယ်** — ၂၈၀ နဲ့ဆို မြစ်ရဲ့
      //   အရှေ့/အနောက် အစွန်းမှာ တောင်က ၁၀–၆၈ m တက်ပြီး **ရေကို
      //   ဖုံးပစ်တယ်** (တိုင်းစစ်ပြီး: x ±၃၀၀ မှာ ၁၀.၀, x ±၄၀၀ မှာ ၅၇–၆၈)。
      //   မြစ်က x ±၃၃၀, z ၃၄၀ အထိ ရှိလို့ အဝေးဆုံး ထောင့်က
      //   √(၃၃၀² + ၉၀²) ≈ ၃၄၂ — ဒါကြောင့် r ၃၅၀。
      flatSpots: [{ x: 0, z: -250, r: 140, blend: 70 }, manor.flatSpot,
                  { x: 0, z: 430, r: 350, blend: 70 }],
    });
    ...
    // ★ x ±၃၃၀ — ပြားတဲ့ဇုန်နဲ့ ကိုက်တယ်၊ အစွန်းနှစ်ဖက်မှာ တောင်က
    //   ပြန်တက်လို့ မြစ်က တောင်ကြားထဲ ပျောက်သွားသလို ဖြစ်တယ်。
    river(this, { z0: 340, z1: 430, x0: -330, x1: 330, gaps: [[150, 182]] });
