...
export class Engine {
  constructor(container = document.body) {
    ...
    this.camera = new THREE.PerspectiveCamera(
      ...
      // ★ near ၀.၁ → ၀.၂၅ — far ကို ၁၂၅၀ တင်လိုက်တော့ far/near အချိုးက
      //   ၁၂,၅၀၀ ဖြစ်ပြီး depth buffer တိကျမှု ကျသွားတယ်။ ရလဒ်: မြစ်ရေ
      //   မျက်နှာပြင် (မြေထက် ၀.၂ m) က အဝေးမှာ မြေနဲ့ လုပြီး တစ်ဝက်
      //   ပျောက်နေတယ် (render နဲ့ တွေ့ခဲ့)。 ၀.၂၅ က တိကျမှုကို ၂.၅ ဆ
      //   တိုးပေးတယ်၊ ကစားသမား ကင်မရာက ၂.၅ m ဝေးလို့ ဘာမှ မဖြတ်ဘူး。
      70, window.innerWidth / window.innerHeight, 0.25, 1250
    );
