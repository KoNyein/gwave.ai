-- ================================================================
-- Messenger — video & file attachments patch
-- Copy into the Supabase SQL Editor and click "Run" (idempotent).
-- Adds file_path / file_kind / file_name to messages and updates the
-- content check so a message can carry text, image, location OR a file.
-- ================================================================
