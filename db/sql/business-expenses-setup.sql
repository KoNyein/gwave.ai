-- ================================================================
-- Business finance — expense manager setup
-- Copy into the Supabase SQL Editor and click "Run" (idempotent-ish;
-- create type will error if already run — that's safe to ignore).
-- Creates business_expenses with owner-scoped RLS.
-- ================================================================
