...
const csp = [
  ...
  // composite replays).
  `media-src 'self' blob: data: https://*.supabase.co https://stream.mux.com https://d10t7bibe827e7.cloudfront.net https://d2fvsrmhrcdf.cloudfront.net https://*.live-video.net${cctvHlsSrc}`,
  "font-src 'self' data:",
