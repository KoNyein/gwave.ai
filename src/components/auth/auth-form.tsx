...
/** The multicolour Google "G", inline so no external asset is needed. */
function GoogleLogo() {
  return (
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {/* Google first: for most people it's one tap with no password to
            remember, so it leads the page; email/password sits below. */}
        <form action={signInWithGoogle}>
          <input type="hidden" name="redirectTo" value={redirectTo} />
          <Button
            type="submit"
            variant="outline"
            className="h-12 w-full gap-3 text-[15px] font-semibold shadow-sm"
          >
            <GoogleLogo />
