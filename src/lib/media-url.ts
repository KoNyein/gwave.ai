 ...
 *
 * 1. lib/media.ts pulls in the browser Supabase client and canvas-based image
 ...
 *    that hardcoded the Supabase Storage URL and never grew the S3 branch, so
 ...
 * set = CloudFront/S3, unset = Supabase Storage. That is what makes the storage
 * backend reversible without a code change.
 */
